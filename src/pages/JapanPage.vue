...
const pageCopy = {
    ja: {
        ...
        featuresHeading: {
            ...
            title: 'AI量化投資の特徴',
            description:
                '最先端のAI技術と量化分析により、安定した投資収益を実現します',
        },
        performanceHeading: {
            kicker: 'Performance',
            title: 'お客様の声',
            description:
                '実際にAI量化投資で成功を収めたお客様の体験談',
        },
        cta: {
            kicker: 'AI量化投資で安定した収益を実現',
            title: '今すぐ始める',
            description:
    ...
    ko: {
        ...
        featuresHeading: {
            ...
            title: 'AI 정량 투자의 특징',
            description:
                '최첨단 AI 기술과 정량 분석으로 안정적인 투자 수익을 실현합니다',
        },
        performanceHeading: {
            kicker: 'Performance',
            title: '고객 후기',
            description:
                '실제로 AI 정량 투자로 성공을 거둔 고객의 경험담',
        },
        cta: {
            kicker: 'AI 정량 투자로 안정적인 수익 실현',
            title: '지금 시작하기',
            description:
...
const testimonials = [
    {
        ...
        content: {
            ja: 'AI量化投資を始めてから、安定した収益を得られるようになりました。リスク管理も自動で行ってくれるので安心です。',
            ko: 'AI 정량 투자를 시작한 이후 안정적인 수익을 얻을 수 있게 되었습니다. 리스크 관리도 자동으로 해주어 안심입니다.',
        },
    },
    {
